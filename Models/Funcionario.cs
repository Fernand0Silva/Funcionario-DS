...
namespace Aula02RH.Models
{
    public class Funcionario
    {
        ...
        //public string ExibirPeriodoExperiencia{get; set;}
       // public int ContarCaracteres{get;set;}
       // public bool ValidarCpf{get; set;} 

       //public TipoFuncionarioEnum TipoFuncionario{ get; set; } Cópia

        public void ReajustarSalario()//Metodo
        {
